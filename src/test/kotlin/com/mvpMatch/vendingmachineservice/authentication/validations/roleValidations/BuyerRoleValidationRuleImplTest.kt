...
class BuyerRoleValidationRuleImplTest{

    @Test
    fun `throw UnAuthorizedUserException when user does not have buyer role`() {
        ...
        val roleValidationRule = BuyerRoleValidationRuleImpl()
    ...
    @Test
    fun `dont throw UnAuthorizedUserException when user does have buyer role`() {
